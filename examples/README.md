# Horoscope API - Examples

This folder contains example code for using the Horoscope API across different platforms.
...
const response = await fetch('https://api.apiverve.com/v1/horoscope', {
...
response = requests.get('https://api.apiverve.com/v1/horoscope',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/horoscope");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/horoscope](https://docs.apiverve.com/ref/horoscope)
