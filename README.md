...
```bash
curl -X GET "https://api.apiverve.com/v1/horoscope?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/horoscope](https://docs.apiverve.com/ref/horoscope)

---

## Use Cases

Common use cases for the Horoscope API:
