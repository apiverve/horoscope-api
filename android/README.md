...
```gradle
dependencies {
    implementation 'com.github.apiverve:horoscope-api:1.1.14'
}
```
...
```java
import com.apiverve.horoscope.HoroscopeAPIClient;
import com.apiverve.horoscope.APIResponse;
import com.apiverve.horoscope.APIException;

// Initialize the client
HoroscopeAPIClient client = new HoroscopeAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("sign", "aries");
    parameters.put("yesterday", true);
    parameters.put("tomorrow", true);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/horoscope](https://docs.apiverve.com/ref/horoscope)
...
- **Documentation:** [https://docs.apiverve.com/ref/horoscope](https://docs.apiverve.com/ref/horoscope)
- **Issues:** [GitHub Issues](https://github.com/apiverve/horoscope-api/issues)
