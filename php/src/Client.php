 ...
 * ```
 *
 * @see https://horoscope.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/horoscope';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HoroscopeClient] {$message}\n";
        }
    }
}
