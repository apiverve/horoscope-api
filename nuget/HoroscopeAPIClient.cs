...
namespace APIVerve.API.Horoscope
{
...
#endif
    {
        ...
        {
            { "sign", new ValidationRule { Type = "string", Required = true } },
            { "yesterday", new ValidationRule { Type = "boolean", Required = false } },
            { "tomorrow", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        private void ValidateParams(HoroscopeQueryOptions options)
        {
