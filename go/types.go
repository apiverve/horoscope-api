// Package horoscope provides a Go client for the Horoscope API.
//
// For more information, visit: https://horoscope.apiverve.com?utm_source=go&utm_medium=readme
package horoscope
...
// Request contains the parameters for the Horoscope API.
//
// Parameters:
//   - sign (required): string - The zodiac sign for which you want to get the horoscope
//   - yesterday: boolean - Set to true to get yesterday's horoscope
//   - tomorrow: boolean - Set to true to get tomorrow's horoscope
type Request struct {
	Sign string `json:"sign"` // Required
	Yesterday bool `json:"yesterday,omitempty"` // Optional
	Tomorrow bool `json:"tomorrow,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"yesterday": {Type: "boolean", Required: false},
		"tomorrow": {Type: "boolean", Required: false},
	}
...
// ResponseData contains the data returned by the Horoscope API.
type ResponseData struct {
	...
	Zodiac ZodiacData `json:"zodiac"`
}

// ZodiacData represents the zodiac object.
type ZodiacData struct {
